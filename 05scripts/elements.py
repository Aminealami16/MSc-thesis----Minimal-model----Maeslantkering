...
def elements_added_mass_wet(n1, n2, ep_K, ep_M, angle):
    """
    Create an element connecting two nodes.
    ...
    M_e, K_e = tm.T_element_added_mass_oscillation_retaining_wall(ex, ey, ez, eo, ep_K, ep_M)
...
def elements_added_mass_truss(n1, n2, ep_K, ep_M, angle):
    """
    Create an element connecting two nodes.
    ...
    M_e, K_e = tm.T_element_added_mass_truss(ex, ey, ez, eo, ep_K, ep_M)
